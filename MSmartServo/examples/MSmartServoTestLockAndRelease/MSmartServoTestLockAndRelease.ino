...
void loop()
{
  mysmartservo.move(1, 180, 50);
  delay(1000);
  if(mysmartservo.setBreak(1, 0))//Lock smartservo
  {
    delay(40);
    mysmartservo.setRGBLed(1,255, 255, 255);
    delay(40);
  }
  delay(5000);
  if(mysmartservo.setBreak(1, 1))//release smartservo
  {
    mysmartservo.setRGBLed(1,0, 255, 0);
    delay(40);
  }
